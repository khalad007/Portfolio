            ...
            <div className="navbar mt-5">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <Link to="/project"><li><a>Project</a></li></Link>
                        <Link to="/getintouch"><li><a>Contact</a></li></Link>

                            
                            {/* <li><a>Testimonials</a></li> */}
                        </ul>
                    </div>
                    <a><img className="w-20 h-11 text-black" src={logo} alt="" /></a>
                </div>
                ...
                <div className="navbar-end">
                    ...
                    <a className="btn btn-sm btn-neutral  ml-7" onClick={handleResumeDownload}>Resume <IoCloudDownloadOutline /></a>
                </div>
            </div>
        </div>
    );
